...
// (Helper functions for weekly charts)
...
function renderExerciseProgressAnalytics(container, gymLogs) {
    ...
    program.days.forEach(day => {
        ...
        Object.keys(hist).forEach(name => {
            ...
            const trend = getExerciseTrend ? getExerciseTrend(entries) : { direction: 'neutral', change: 0, bestWeight: 0 };
            html += `
...
function renderStatsAnalytics(container, weighIns, gymLogs, settings) {
    // (same as before - using your latest version)
