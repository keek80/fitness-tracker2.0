...
function renderDashboard() {
    ...
    const sessionChips = (typeof renderSessionChips === 'function')
        ? renderSessionChips(program, todaysWorkoutDay ? todaysWorkoutDay.id : null, scheduledWorkoutDay ? scheduledWorkoutDay.id : null, 'pickDashboardWorkout')
        : '';
    ...
    if (todaysWorkoutDay) {
        const subtitle = isSwapped
            ? `${todayDayOfWeek} · ${todaysWorkoutDay.exercises.length} exercises · usually ${scheduledWorkoutDay.name}`
